                ...
                {nodes.map((node) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div
                                key={node.id}
                                className={`border rounded-[2rem] p-6 transition-all duration-300 ${statusClasses} hover:background-color: ${isOnline ? 'hover:bg-success/20' : 'hover:bg-error/20'} cursor-pointer`}
                            >
                                {/* Info Node & Status */}
