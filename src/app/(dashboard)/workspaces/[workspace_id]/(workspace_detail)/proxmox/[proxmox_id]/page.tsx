      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4">
          {nodes.map((node) => (
            <div 
              key={node.id} 
              className="group p-5 bg-base-100 rounded-xl border border-base-300 shadow-sm hover:shadow-md transition-all flex flex-col md:flex-row md:items-center justify-between gap-4"
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className={`px-4 py-1.5 rounded-lg font-bold text-xs uppercase tracking-widest ${
                  node.online 
