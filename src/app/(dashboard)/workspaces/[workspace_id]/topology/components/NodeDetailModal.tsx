...
export function NodeDetailModal({
  ...
  const modalContent = (
    <div className="modal modal-open z-[9999]">
      {/* modal-box: flex column, max 90vh so it never exceeds viewport */}
      <div className="modal-box w-11/12 max-w-6xl border border-base-300 shadow-2xl bg-base-100 p-0 flex flex-col max-h-[90vh]">

        {/* ── Header (view) — sticky at top, does not scroll ── */}
        {!isEditingNode && (
          <div className={`flex-shrink-0 p-6 ${nodeDetail ? 'bg-base-200' : 'animate-pulse bg-base-300'}`}>
        ...
        {/* ── Header (edit node form) — sticky at top ── */}
        ...
        <div className="flex-shrink-0 p-6 bg-base-200/50 border-t border-base-300">
          {deleteNodeConfirm ? (
      ...
      {/* modal-backdrop is a SIBLING of modal-box, not inside it */}
