...
export default function Navbar() {
  ...
  const proxmoxId = params.proxmox_id // Ambil proxmox_id dari URL [proxmox_id]
      ...
      >
        <div>
          ...
          <ul className="menu p-4 space-y-1 text-base font-semibold">
            <li><Link href={`/workspaces/${workspaceId}/proxmox/${proxmoxId}`} onClick={() => setSidebarOpen(false)}><DashboardIcon /> Dasboard</Link></li>
            <li><Link href={`/workspaces/${workspaceId}/proxmox/${proxmoxId}/nodes`} onClick={() => setSidebarOpen(false)}><NodeIcon /> Node List</Link></li>
            <li><Link href={`/workspaces/${workspaceId}/proxmox/${proxmoxId}/resources`} onClick={() => setSidebarOpen(false)}><ResourcesIcon /> Resources</Link></li>
            <li><Link href={`/workspaces/${workspaceId}/proxmox/${proxmoxId}/recent-tasks`} onClick={() => setSidebarOpen(false)}><TaskIcon /> Recent Tasks</Link></li>
            {/* VM List */}
            <li><Link href={`/workspaces/${workspaceId}/proxmox/${proxmoxId}/vms`} onClick={() => setSidebarOpen(false)}><VMIcon /> VM List</Link></li>
            {/* CT List */}
            <li><Link href={`/workspaces/${workspaceId}/proxmox/${proxmoxId}/cts`} onClick={() => setSidebarOpen(false)}><CTIcon /> CT List</Link></li>
          </ul>
        </div>
